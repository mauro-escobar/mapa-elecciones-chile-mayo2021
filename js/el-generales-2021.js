    ...
    map.on('mousemove', 'presidenciales-comunas', function (e) {
        ...
        popup.setLngLat(e.lngLat)
            .setHTML(
                ...
                '<tr style="font-weight:bold"><td><span class="legend-key" style="background-color:'+colores['verde-agua']+'"></span>GABRIEL BORIC FONT</td><td style="text-align:right;padding-left:20px">'+e.features[0].properties.vot_1+'</td><td style="text-align:right;padding-left:20px">'+e.features[0].properties.pct_1+'%</td></tr>'+
                '<tr style="font-weight:bold"><td><span class="legend-key" style="background-color:'+colores['azul-marino']+'"></span>JOSE ANTONIO KAST RIST</td><td style="text-align:right;padding-left:20px">'+e.features[0].properties.vot_2+'</td><td style="text-align:right;padding-left:20px">'+e.features[0].properties.pct_2+'%</td></tr>'+
